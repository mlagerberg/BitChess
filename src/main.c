...
void usage() {
	...
	printf("              capital letter must denote what piece to promote to, e.g.: 'e8=Q'.\n");
	printf("              Castling can be performed by 'O-O' or 'O-O-O' (capital 'oh', not\n");
	printf("              zeros).\n");
	...
	printf("              move.\n");
	printf(" backup <n>   Backs up the current game to a file with the specified number <n>.\n");
	...
	printf("              For pawn promotions, append an extra capital letter: 'e7-e4Q'.\n");
	printf("              Automatically also enables silent mode, i.e.: -s.\n");
